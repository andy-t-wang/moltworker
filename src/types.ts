...
export interface MoltbotEnv {
  ...
  TELEGRAM_DM_ALLOW_FROM?: string; // Optional comma-separated Telegram user IDs allowed when dmPolicy=open
  ...
  CF_ACCESS_ALLOWED_EMAILS?: string; // Optional comma-separated email allowlist for Access-authenticated users
